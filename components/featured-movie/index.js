...
function FeatureMovie({ movie = {}, isCompact = true }) {
    //movie props'u container tarafından geliyor.
    //isCompact filmin açıklamasını kısaltmak için kullanılıyor

    //movie altında gelen poster başlık ve açıklama bulunuyor
